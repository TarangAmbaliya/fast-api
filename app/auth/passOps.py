...
def verify_hash(in_password: str, in_hash: str) -> bool:
    ...
    :param in_password: The password entered by the user during login.
    :param in_hash: The hash stored in the database corresponding to that user.
    :return: True if hash matches, False if it dosen't.
    """
